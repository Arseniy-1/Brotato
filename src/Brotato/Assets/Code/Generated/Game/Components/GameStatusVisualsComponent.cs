...
public partial class GameEntity {
    ...
    public Code.Gameplay.Common.StatusVisuals.IStatusVisuals StatusVisuals { get { return statusVisuals.Value; } }
    public bool hasStatusVisuals { get { return HasComponent(GameComponentsLookup.StatusVisuals); } }

    public GameEntity AddStatusVisuals(Code.Gameplay.Common.StatusVisuals.IStatusVisuals newValue) {
    ...
    public GameEntity ReplaceStatusVisuals(Code.Gameplay.Common.StatusVisuals.IStatusVisuals newValue) {
        var index = GameComponentsLookup.StatusVisuals;
        var component = (Code.Gameplay.Common.StatusVisualsComponent)CreateComponent(index, typeof(Code.Gameplay.Common.StatusVisualsComponent));
        component.Value = newValue;
