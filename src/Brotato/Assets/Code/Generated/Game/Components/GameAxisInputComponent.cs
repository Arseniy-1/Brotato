...
public partial class GameEntity {
    ...
    public Code.Gameplay.Input.InputComponent.AxisInput axisInput { get { return (Code.Gameplay.Input.InputComponent.AxisInput)GetComponent(GameComponentsLookup.AxisInput); } }
    ...
    public GameEntity AddAxisInput(UnityEngine.Vector2 newValue) {
        ...
        var component = (Code.Gameplay.Input.InputComponent.AxisInput)CreateComponent(index, typeof(Code.Gameplay.Input.InputComponent.AxisInput));
