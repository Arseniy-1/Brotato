        ...
        public void Execute()
        {
            ...
            foreach (GameEntity timer in _timers)
            {
                ...
                if (timer.SpawnTimer <= 0)
                {
                    ...
                    _enemyFactory.CreateEnemy(EnemyTypeId.BabyAlient, at: RandomSpawnPosition(hero.WorldPosition));
                }
            }
        }

        private Vector3 RandomSpawnPosition(Vector2 heroWorldPosition)
        {
